...
export const MunicipalityOverview = () => {
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-white p-6 md:p-8 rounded-xl border border-slate-200 shadow-xs">
        <div>
          <div className="flex items-center gap-2 text-xs font-bold text-[#dc2626] uppercase tracking-wider mb-1">
            ...
            <span>Kathmandu Metropolitan Authority</span>
          </div>
        ...
        <button
          ...
          className="bg-slate-900 text-white px-4 py-2 rounded-lg text-xs font-medium flex items-center gap-2 hover:bg-slate-800 shadow-xs cursor-pointer"
        >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-xs space-y-4">
          <h3 className="text-sm font-bold text-slate-900 flex items-center justify-between">
            ...
            <span className="text-xs font-normal text-slate-400">Total Count</span>
          </h3>
        ...
        <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-xs space-y-4">
          <h3 className="text-sm font-bold text-slate-900 flex items-center justify-between">
            ...
            <span className="text-xs text-[#dc2626] font-semibold">Urgent</span>
          </h3>
            ...
            {issues
              ...
              .map((issue) => (
                ...
                >
                  ...
                  <span className="text-[10px] font-bold px-2 py-0.5 rounded bg-red-50 text-[#dc2626] border border-red-200 uppercase whitespace-nowrap">
      ...
      {/* Comprehensive Municipal Grievance & Incident Registry */}
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-2 border-b border-slate-100">
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="text-[10px] bg-red-50 text-[#dc2626] font-semibold px-2 py-0.5 rounded border border-red-200 flex items-center gap-1">
                <span className="w-1.5 h-1.5 rounded-full bg-red-500 animate-pulse"></span>
                Newest On Top
              </span>
            </div>
            <p className="text-xs text-slate-500">
              Full directory of citizen reports across all wards ({issues.length} total, arranged serially by arrival)
            </p>
          </div>
          ...
          <div className="flex items-center gap-2">
            <select
              ...
              className="text-xs bg-slate-50 border border-slate-200 rounded-lg px-2.5 py-1.5 font-medium text-slate-700 focus:outline-none focus:ring-1 focus:ring-red-500"
            >
